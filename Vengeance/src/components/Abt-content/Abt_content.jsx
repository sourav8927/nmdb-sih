...
function Abt_content()
{
   ...
   <div className="row">
     <div className="col-md-6 p-4 p-sm-5 order-2 order-sm-1 sp">
       <h1 className="h2 mb-4 fw">Implementation Structure</h1>
       <p className="text-secondary lineh">Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit repellat iure laboriosam cum voluptatum, nam minima deserunt aut? Distinctio voluptatibus dolor quaerat quo omnis illo sequi at velit, odit quod!</p>
       <a href="#" className="btn px-4 py-3 mt-4 text-white d-flex align-items-center justify-content-between downpro">
        ...
        <svg width="25px" fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
           viewBox="0 0 489 489" className="vb" xml:space="preserve" />
        <g>
          <g>
    ...
    <div className="col-md-6 p-4 p-sm-5">
      <h1 className="h2 mb-4 0 fw">Welcome to Nasha Mukt Bharat Abhiyaan</h1>
      <p className="text-secondary lineh">Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit repellat iure laboriosam cum voluptatum, nam minima deserunt aut? Distinctio voluptatibus dolor quaerat quo omnis illo sequi at velit, odit quod!</p>
      <a href="#"  className="btn px-4 py-3 mt-4 text-white d-flex align-items-center justify-content-between lb">
